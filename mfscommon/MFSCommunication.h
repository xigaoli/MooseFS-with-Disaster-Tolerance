...
// 0x0032
#define SSTOMA_REGISTER (PROTO_BASE+70)
// rver:8
// 	rver==1:
// 		version:32 timeout:16

// 0x0033
//#define MATOSS_METACHANGES_LOG (PROTO_BASE+71)
// 0xFF:8 version:64 logdata:string ( N*[ char:8 ] ) = LOG_DATA
// 0x55:8 = LOG_ROTATE

// 0x003C
//#define SSTOMA_DOWNLOAD_START (PROTO_BASE+80)
// -

// 0x003D
//#define MATOSS_DOWNLOAD_START (PROTO_BASE+81)
// status:8
// length:64

// 0x003E
#define SSTOMA_DOWNLOAD_DATA (PROTO_BASE+82)
// offset:64 leng:32

// 0x003F
#define MATOSS_DOWNLOAD_DATA (PROTO_BASE+83)
// offset:64 leng:32 crc:32 data:lengB

// 0x0040
#define SSTOMA_DOWNLOAD_END (PROTO_BASE+84) 
// -
#define MATOSS_DOWNLOAD_END (PROTO_BASE+85) //代表发送内容为空

// 0x0042
#define SSTOMA_ID_DATA (PROTO_BASE+86) //代表请求inode对应路径

// 0x0043
#define MATOSS_ID_DATA (PROTO_BASE+87)//代表发送inode对应路径
